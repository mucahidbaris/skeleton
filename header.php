...
//$user=new User($db);
if(!$admin->islogin()){ header("location:login.php");  exit();}
$px1x1="iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAC0lEQVQIW2NgAAIAAAUAAR4f7BQAAAAASUVORK5CYII=";
...
<head>
    ...
    <script src="assets/js/plugins/jquery-ui/jquery.ui.spinner.js"></script>
    ...
    <!-- PLUpload -->
    <script src="assets/js/plugins/plupload/plupload.full.js"></script>
    <script src="assets/js/plugins/plupload/jquery.plupload.queue.js"></script>
    <!-- Custom file upload -->
...
<div id="modal-user" class="modal hide">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 id="user-infos">Bilinmiyor</h3>
    </div>
...
<div id="navigation">
    ...
    <div class="container-fluid">
        ...
        <?php
        //firmasec ekranında menüleri göstermiyoruz.
        if($_SERVER['PHP_SELF'] !='/firmasec.php')://todo yetkiye göre menü göster  ?>
        <ul class='main-nav'>
            <li class='active'>
                <a href="index.html">
                    <span>Anasayfa</span>
        ...
        <div class="user">
            <div class="dropdown">
                <a href="#" class='dropdown-toggle' data-toggle="dropdown"><?=(isset($_SESSION['firma_name'])) ? $_SESSION['firma_name']: NULL?> <img  style="height: 27px; !important;" src="data:@file/octet-stream;base64,<?=base64_encode((isset($_SESSION['firma_logo']))?$_SESSION['firma_logo']: $px1x1)?>" alt=""></a>
                <ul class="dropdown-menu pull-right">
                    <li>
                        <a href="#">Profil Düzenle</a>
                    </li>
                    <li>
                        <a href="firmasec.php">Firma Değiştir</a>
                    </li>
                    <li>
...
<div class="container-fluid" id="content">
    <!-- //firmasec ekranında menüleri göstermiyoruz. -->
    <?php  if($_SERVER['PHP_SELF'] !='/firmasec.php'):   ?>
    <div id="left">
        ...
        <div class="subnav">
            <div class="subnav-title">
                <a href="#" class='toggle-subnav'><i class="icon-angle-down"></i><span>Kullanıcı İşlemleri</span></a>
            </div>
            <ul class="subnav-menu">
                ...
                <li>
                    <a href="#">Kullanıcı Yetki</a>
                </li>
            </ul>
        </div>
        <div class="subnav">
            <div class="subnav-title">
                <a href="#" class='toggle-subnav'><i class="icon-angle-down"></i><span>Firma İşlemleri</span></a>
            </div>
            <ul class="subnav-menu">
        ...
        <div class="subnav">
            <div class="subnav-title">
                <a href="#" class='toggle-subnav'><i class="icon-angle-down"></i><span>Ürün & Üretim</span></a>
            </div>
            <ul class="subnav-menu">
                ...
                <li>
                    <a href="urun_spp.php">Ürün Özelllikleri</a>
                </li>
